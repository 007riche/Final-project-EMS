            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> @if (isset(auth()->user()->role->permission['name']['department']['can-delete']))
                            <a href="#" data-bs-toggle="modal" data-bs-target="#delete{{$department->id}}"> <i class="fas fa-trash "></i></a>
                            @endif
                            <!-- Modal -->
                                    ...
                                    <form action="{{route('departments.destroy', [$department->id])}}" method="post">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Do you really want to delete the {{$department->name}} department?
                                            </div>
