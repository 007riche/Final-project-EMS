            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$key+1}}</td>
                        <td> <img src="{{asset('profile')}}/{{$user->image}}" class="rounded-circle" alt="" width="50"></td>
                        <td>{{$user->name}}</td>
                        <td>{{$user->email}}</td>
                        ...
                        <td> @if (isset(auth()->user()->role->permission['name']['user']['can-delete']))
                            <a href="#" data-bs-toggle="modal" data-bs-target="#delete{{$user->id}}"> <i class="fas fa-trash "></i> </a>
                            @endif
                                    ...
                                    <form action="{{route('users.destroy', [$user->id])}}" method="post">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Do you really want to delete the {{$user->name}} user?
                                            </div>
